...
| Azure AI Foundry | Deployment Guide | MAF Middleware | `AgentControlMW`, `CapabilityGuardMiddleware`, `AuditTrailMiddleware`, `RogueDetectionMiddleware`. |
...
- **Foundry agents** get native middleware integration (`AgentControlMW`, `CapabilityGuardMiddleware`, `AuditTrailMiddleware`) — governance is invisible and automatic.
